  ...
  return (
    <div>
      {message && <p className={`mt-4 ${message.includes("✅") ? "text-green-400" : "text-red-400"}`}>{message}</p>}
        ...
        <div className="max-w-sm  border border-gray-200 rounded-lg shadow-lg overflow-hidden w-[250px] hover:shadow-2xl transition-shadow duration-300 m-5 bg-neutral-200">
      {/* Product Image */}
      <img
